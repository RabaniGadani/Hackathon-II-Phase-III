...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen flex">
        ...
        <div className="w-full max-w-md">
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-white text-gray-500">New to TodoApp?</span>
            </div>
          </div>
      ...
      <div className="hidden lg:flex lg:flex-1 bg-gradient-to-br from-green-500 to-emerald-600 relative overflow-hidden">
        ...
        <div className="relative flex flex-col justify-center px-16 text-white">
          <div className="max-w-md">
            ...
            <p className="text-green-100 text-lg leading-relaxed mb-10">
              Join thousands of users who trust TodoApp to manage their daily tasks and boost productivity.
            </p>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4">
                ...
                <span className="text-green-50">Intuitive task management</span>
              </div>
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-xl bg-white/20 flex items-center justify-center">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-green-50">Real-time synchronization</span>
              </div>
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-xl bg-white/20 flex items-center justify-center">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-green-50">Secure and private</span>
              </div>
            </div>
          </div>
        </div>
